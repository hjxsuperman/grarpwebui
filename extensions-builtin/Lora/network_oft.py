...
# Supports both kohya-ss' implementation of COFT  https://gitclone.com/github.com/kohya-ss/sd-scripts/blob/main/networks/oft.py
# and KohakuBlueleaf's implementation of OFT/COFT https://gitclone.com/github.com/KohakuBlueleaf/LyCORIS/blob/dev/lycoris/modules/diag_oft.py
