...
# Arc GPU cannot allocate a single block larger than 4GB: https://gitclone.com/github.com/intel/compute-runtime/issues/627
...
if has_xpu:
    try:
        ...
        # W/A for https://gitclone.com/github.com/intel/intel-extension-for-pytorch/issues/452: torch.Generator API doesn't support XPU device (for torch < 2.1)
