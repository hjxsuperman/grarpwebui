...
model_url = "https://gitclone.com/github.com/TencentARC/GFPGAN/releases/download/v1.3.0/GFPGANv1.4.pth"
    ...
    def load_net(self) -> torch.Module:
        for model_path in modelloader.load_models(
            ...
            if 'GFPGAN' in os.path.basename(model_path):
                ...
                model.different_w = True  # see https://gitclone.com/github.com/chaiNNer-org/spandrel/pull/81
                return model
